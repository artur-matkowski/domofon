 ...
 *
 * The camera bitmap is deliberately *not* here: data-class equality over a mutable Bitmap
 * is meaningless, and delivery differs per surface (a file URL crosses the QML bridge, a
